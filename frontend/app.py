...
Product_Weight = st.number_input("Product Weight", min_value=4.0, max_value=9.99, step=0.1, value=4.0)
...
Product_MRP = st.number_input("Product MRP", min_value=31.0, max_value=254.34, step=0.01, value=31.0)
